var Masking = function () {
    ...
    return {
        ...
        initMasking: function () {
	        ...
	        jQuery("#telephone").mask('999-999-9999', {placeholder:'X'});
	        jQuery("#Phone_ref1").mask('999-999-9999', {placeholder:'X'});
	        jQuery("#Phone_ref2").mask('999-999-9999', {placeholder:'X'});
	        /*jQuery("#ssn").mask('999-99-9999', {placeholder:'X'});*/
	        jQuery("#ssnI9").mask('999-99-9999', {placeholder:'X'});
