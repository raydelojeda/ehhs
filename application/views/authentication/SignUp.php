<form class="reg-page" id='frm_auth'>
	...
	<div class="col-md-12 input-group margin-bottom-5">
		...
		<select name="sec1" id="sec1" class="my_select2" style="width: 100%;">
			<option value="-1"></option>
			<option value="1">What is the name of the person you first kissed?</option>
			...
			<option value="4">What is your favorite wine?</option>
			...
			<option value="7">In what city did your mother and father meet?</option>
			...
			<option value="14">What was the hospital where you were born?</option>
			<option value="15">What was the last name of your 3rd grade teacher?</option>
		</select>
	</div>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function()
    {
        ...
        function CheckExistUserID(goahead='')
        {
        ...
        function CheckExistEmail(goahead='')
        {
            var email=jQuery('#email').val();
            ...
            if(email.length>12)
            {
                ...
                }).done(function(response, textStatus, jqXHR)
                {
                    ...
                    {
                        jQuery('#ok_mail').val('1');//alert(goahead);
                        if(goahead==1)CheckExistUserID(goahead);
                    }
