            ...
            <ul>
                ...
                <li data-transition="3dcurtain-vertical" data-slotamount="40" data-masterspeed="400" data-thumb="<?php print base_url('assets/images/slider/revolution/thumbs/thumb1.jpg'); ?>">
                    ...
                    <div class="caption randomrotate"
                         ...
                         data-start="1700"
                         data-easing="easeOutExpo">
                        <img width="210px;" class="img-border"style='border-radius:5px !important;' src="<?php print base_url('assets/images/slider/revolution/bg2.png'); ?>" alt="Image 7">
                    </div>
                ...
                <li data-transition="papercut" data-slotamount="15" data-masterspeed="300" data-delay="15000">
                    ...
                    <div class="caption modern_medium_light lfl stl"
                         ...
                         data-speed="500"
                         data-start="4500"
                         data-easing="easeOutExpo" data-end="14500" data-endspeed="300" data-endeasing="easeInSine">
                    ...
                    <div class="caption modern_medium_light lfl stl"
                         ...
                         data-speed="500"
                         data-start="5500"
                         data-easing="easeOutExpo" data-end="15500" data-endspeed="300" data-endeasing="easeInSine">
