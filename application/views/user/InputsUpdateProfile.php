...
?>
	<div class="col-sm-12">
		...
		<div class="form-group">
			...
			<input type="text" name="second_name" id="second_name" class="form-control" value="<?php if(isset($data['profile']['data']->second_name)) print $data['profile']['data']->second_name;?>" />
		</div>
				...
				}).done(function(response, textStatus, jqXHR)
				{
                    if(jQuery.isNumeric(response))
                    {
                        ...
                        else if('<?php print $role;?>'=='patient')
                        {
                            ...
                            jQuery('#tab100').show().tab('show');
                            jQuery('#s2').removeClass('active').addClass('fade');
                            jQuery('#s100').removeClass('fade').addClass('active');
                            goToByScroll('tab100');
                        }
                    }
