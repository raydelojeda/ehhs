	...
	<div class="col-sm-12">
		<fieldset class="myfieldset">
			...
			<div style='text-align:justify;'>
                ...
                <p><div id="medical_lb1"><?php print $lb;?></div><input  type="text" name="medical_data1" id="medical_data1" class="form-control" size='10' style='width:100px !important;' value="<?php if(isset($sign) && $sign!='') print $sign;$sign='';?>"></p>
                ...
                <p><div id="medical_lb2"><?php print $lb;?></div><input  type="text" name="medical_data2" id="medical_data2" class="form-control" size='10' style='width:100px !important;' value="<?php if(isset($sign) && $sign!='') print $sign;$sign='';?>"></p>
                ...
                <p><div id="medical_lb3"><?php print $lb;?></div><input  type="text" name="medical_data3" id="medical_data3" class="form-control" size='10' style='width:100px !important;' value="<?php if(isset($sign) && $sign!='') print $sign;$sign='';?>"></p>
            ...
            ?>
            <input  type="hidden" name="medical_id_consent1" id="medical_id_consent1" value="<?php if(isset($id_consent)) print $id_consent;?>" />
			...
			<div class="form-group">
				...
				<input  type="text" name="medical_initial1" id="medical_initial1" class="form-control required" size='4' style='width:100px !important;' value="<?php if(isset($sign) && $sign!='') print $sign;$sign='';?>"/>
			</div>
		...
		<fieldset class="myfieldset">
            ...
            ?>
            <input  type="hidden" name="medical_id_consent2" id="medical_id_consent2" value="<?php if(isset($id_consent)) print $id_consent;?>" />
			...
			<div class="form-group">
                ...
                <input  type="text" name="medical_initial2" id="medical_initial2" class="form-control required" size='4' style='width:100px !important;' value="<?php if(isset($sign) && $sign!='') print $sign;$sign='';?>"/>
			</div>
		...
		<fieldset class="myfieldset">
            ...
            ?>
            <input  type="hidden" name="medical_id_consent3" id="medical_id_consent3" value="<?php if(isset($id_consent)) print $id_consent;?>" />
			...
			<div class="form-group">
                ...
                <input  type="text" name="medical_initial3" id="medical_initial3" class="form-control required" size='4' style='width:100px !important;' value="<?php if(isset($sign) && $sign!='') print $sign;$sign='';?>"/>
			</div>
		...
		<div class="row">   
			<section class="col col-8">
				<div class="form-group">
                    ...
                    <input  type="text" name="medical_form_sign" id="medical_form_sign" class="form-control required" value="<?php if(isset($data['form']['data']->form_sign)) print $data['form']['data']->form_sign;?>"/>
				</div>
			</section>
