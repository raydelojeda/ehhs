	...
	<div class="col-sm-12">
		<fieldset class="myfieldset">
			...
			<div class="form-group">
				...
				<input  type="text" name="equipment_initial1" id="equipment_initial1" class="form-control required" size='4' style='width:100px !important;' value="<?php if(isset($sign) && $sign!='') print $sign;$sign='';?>"/>
			</div>
		...
		<fieldset class="myfieldset">
			...
			<div class="form-group">
                ...
                <input  type="text" name="equipment_initial2" id="equipment_initial2" class="form-control required" size='4' style='width:100px !important;' value="<?php if(isset($sign) && $sign!='') print $sign;$sign='';?>"/>
			</div>
		
		</fieldset>
		
		<fieldset class="myfieldset">
            <?php $lg='Waiver of rights';?>
            <legend class="mylegend" id="equipment_lg2"><?php print $lg;?></legend>
            <?php //var_dump($data);
            if(isset($data['consent']['data']) && $data['consent']['data']!='')
            {//var_dump($data['consent']['data']);
            ...
            ?>
            <input type="hidden" name="equipment_id_consent21" id="equipment_id_consent21" value="<?php if(isset($id_consent)) print $id_consent;?>" />


            <div style='text-align:justify;'>
				<p>I, the undersigned, understand that the hazards of my job; have been fully explained to me by my supervisor: _____________________________________</p>
				<p>I further acknowledge that my employer has supplied me and/or I have supplied the following Personal Protective Equipment:</p>
				<p>_______________________________________________________________________</p>
				<p>_______________________________________________________________________</p>
				<p>_______________________________________________________________________</p>

				<p>I understand that it is necessary for me to use this Personal Protective Equipment to fully protect myself from the hazards of my job.</p>
				<p>I realize that in the event I do not use all of this Personal Protective Equipment and I sustain a personal injury caused by my failure to use/wear said Personal Protective Equipment, I may be denied up to 25% of the indemnity portion of my claim. As provided by this State's Workers' Compensation statues.</p>
			</div>
		...
		<fieldset class="myfieldset">
			...
			<div class="form-group">
                ...
                <input  type="text" name="equipment_initial3" id="equipment_initial3" class="form-control required" size='4' style='width:100px !important;' value="<?php if(isset($sign) && $sign!='') print $sign;$sign='';?>"/>
			</div>
		...
		<div class="row">   
			<section class="col col-8">
				<div class="form-group">
                    ...
                    <input  type="text" name="equipment_form_sign" id="equipment_form_sign" class="form-control required" value="<?php if(isset($data['form']['data']->form_sign)) print $data['form']['data']->form_sign;?>"/>
				</div>
			</section>
