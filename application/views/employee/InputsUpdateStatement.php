	...
	<div class="col-sm-12">
		<fieldset class="myfieldset">
            ...
            <legend class="mylegend" id="statement_lg1"><?php print $lg;?></legend>
            <?php //var_dump($data);
            ...
            ?>
            <input type="hidden" name="statement_id_consent1" id="statement_id_consent1" value="<?php if(isset($id_consent)) print $id_consent;?>" />
			...
			<div class="form-group">
                ...
                <input  type="text" name="statement_initial1" id="statement_initial1" class="form-control required" size='4' style='width:100px !important;' value="<?php if(isset($sign) && $sign!='') print $sign;$sign='';?>"/>
			</div>
		...
		<fieldset class="myfieldset">
            ...
            <legend class="mylegend" id="statement_lg2"><?php print $lg;?></legend>
            <?php
            if(isset($data['consent']['data']) && $data['consent']['data']!='')
            {
                foreach ($data['consent']['data'] as $row)
            ...
            ?>
            <input type="hidden" name="statement_id_consent2" id="statement_id_consent2" value="<?php if(isset($id_consent)) print $id_consent;?>" />
			...
			<div class="form-group">
                ...
                <input  type="text" name="statement_initial2" id="statement_initial2" class="form-control required" size='4' style='width:100px !important;' value="<?php if(isset($sign) && $sign!='') print $sign;$sign='';?>"/>
			</div>
		...
		<fieldset class="myfieldset">
            ...
            <legend class="mylegend" id="statement_lg3"><?php print $lg;?></legend>
            <?php
            if(isset($data['consent']['data']) && $data['consent']['data']!='')
            {
                foreach ($data['consent']['data'] as $row)
            ...
            ?>
            <input type="hidden" name="statement_id_consent3" id="statement_id_consent3" value="<?php if(isset($id_consent)) print $id_consent;?>" />
			...
			<div class="form-group">
                ...
                <input  type="text" name="statement_initial3" id="statement_initial3" class="form-control required" size='4' style='width:100px !important;' value="<?php if(isset($sign) && $sign!='') print $sign;$sign='';?>"/>
			</div>
		...
		<div class="row">   
			<section class="col col-8">
				<div class="form-group">
                    ...
                    <input  type="text" name="statement_form_sign" id="statement_form_sign" class="form-control required" value="<?php if(isset($data['form']['data']->form_sign)) print $data['form']['data']->form_sign;?>"/>
				</div>
			</section>
			
			<section class="col col-4">
				<label>Date</label>
                <input type="text" name="statement_today_date" id="statement_today_date" class="form-control required" disabled='disabled'  value="<?php print date('m/d/Y');?>" />
			</section>
		</div>
		...
		<div class="form-group pull-right">
            ...
            <input type="hidden" name="statement_id_form" id="statement_id_form" value="<?php if(isset($data['form']['data']->id_form)) print $data['form']['data']->id_form;?>" />
		</div>
...
<script type="text/javascript">
    jQuery(document).ready(function()
    {
        ...
        {
            ValidateFrm('frm5');
			if (jQuery("#frm5").valid()) 
			{
                var consent_name1=jQuery('#statement_lg1').html();
                var consent_name2=jQuery('#statement_lg2').html();
                var consent_name3=jQuery('#statement_lg3').html();

                var sign1=jQuery('#statement_initial1').val();
                var sign2=jQuery('#statement_initial2').val();
                var sign3=jQuery('#statement_initial3').val();

                var id_consent1=jQuery('#statement_id_consent1').val();
                var id_consent2=jQuery('#statement_id_consent2').val();
                var id_consent3=jQuery('#statement_id_consent3').val();

                var form_name='statement';
                var form_sign=jQuery('#statement_form_sign').val();
                var date=jQuery('#statement_today_date').val();

                var id_employee=jQuery('#id_employee').val();
                var id_form=jQuery('#statement_id_form').val();

                var completed_percent=15;
                ...
                }).done(function(response, textStatus, jqXHR)
                {
                    if(jQuery.isNumeric(response) && response>0)
                    {
                        ...
                        jQuery('#statement_initial1').attr('readonly', true);
                        jQuery('#statement_initial2').attr('readonly', true);
                        jQuery('#statement_initial3').attr('readonly', true);
                        ...
                        if('<?php print $data['role']['data']->rol;?>'=='worker')
                        {
                            ...
                            jQuery('#s5').removeClass('active').addClass('fade');
                            jQuery('#s6').removeClass('fade').addClass('active');
                            goToByScroll('tab6');
                        }
                    }
