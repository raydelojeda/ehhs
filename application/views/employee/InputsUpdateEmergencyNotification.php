	...
	<div class="col-sm-12">
		...
		<fieldset class="myfieldset">
			...
			<div class="form-group">
				...
				<input  type="text" name="emergency_initial1" id="emergency_initial1" class="form-control required" size='4' style='width:100px !important;' value="<?php if(isset($arr[0]['emergency_initial1']))print $arr[0]['emergency_initial1'];?>"/>
		...
		<div class="row">   
			<section class="col col-8">
				<div class="form-group">
                    ...
                    <input  type="text" name="emergency_form_sign" id="emergency_form_sign" class="form-control required" value="<?php if(isset($arr[0]['emergency_form_sign']))print $arr[0]['emergency_form_sign'];?>"/>
				</div>
			</section>
            ...
            if (jQuery("#frm12").valid())
            {
                ...
                }).done(function(response, textStatus, jqXHR)
                {
                    if(jQuery.isNumeric(response) && response>0)
                    {
                        ...
                        jQuery("#frm12 input").prop("disabled", true);
                        jQuery('#btn_save_12').hide();
