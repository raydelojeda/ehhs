...
<div class="col-sm-12">
    ...
    <div style="width: 100%; font-family: Arial, Helvetica, sans-serif;">
        <div style="width: 100%; font-size: 7pt;">
            <div class="col-sm-2" style="padding:0px;float: left; height: 105px; border-bottom: 2px solid black; border-right: 2px solid black;">
                <div style="clear: both; position: relative; bottom: 8px;">
                    Form <span style="font-weight: bold; font-size: 20pt; padding-left: 8px;">W-9</span>
                    <br />
                    (Rev. November 2017)
                    <br />
            ...
            <div class="col-sm-6" style="padding:0px;float: left; height: 105px; border-bottom: 2px solid black; border-right: 2px solid black; text-align: center; font-weight: bold; font-size: 14pt;">
            ...
            <div class="col-sm-4" style="padding:0px;float: left; height: 105px; border-bottom: 2px solid black; font-size: 9pt; font-weight: bold; vertical-align: middle;">
        ...
        <div style="width: 100%;">
            ...
            <div class="row" style="margin:0px;clear: both;  border-top: 1px solid black; border-bottom: 1px solid black;">
                <div class="col-sm-1" style="float: left; border-right: 1px solid black;  font-size: 10pt; font-weight: bold;">
                    Sign
                    <br/ >
                    Here
                </div>
                ...
                <div class="col-sm-4" style="text-align: left;padding-top: 7px;">
                    <input name="sign" id="sign" type="text" class="form-control" style="display: inline;border-width: 0px 0px 1px 0px;"  value="<?php if(isset($arr[0]['sign']))print $arr[0]['sign'];?>">
                </div>
                ...
                <div class="col-sm-3" style="text-align: left;padding-top: 7px;">
                    <input type="text" id="datew9" class="form-control" style="display: inline;border-width: 0px 0px 1px 0px;"disabled='disabled'  value="<?php print date('m/d/Y');?>">
                </div>
            </div>
        </div>
