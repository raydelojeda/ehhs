	...
	<div class="col-sm-12">
		<fieldset class="myfieldset">
			...
			<div class="form-group">
				...
				<input  type="text" name="probation_initial1" id="probation_initial1" class="form-control required" size='4' style='width:100px !important;' value="<?php if(isset($sign) && $sign!='') print $sign;$sign='';?>"/>
			</div>
		...
		<fieldset class="myfieldset">
			...
			<div class="form-group">
				...
				<input  type="text" name="probation_initial2" id="probation_initial2" class="form-control required" size='4' style='width:100px !important;' value="<?php if(isset($sign) && $sign!='') print $sign;$sign='';?>"/>
			</div>
		...
		<fieldset class="myfieldset">
			...
			<div class="form-group">
				...
				<input  type="text" name="probation_initial3" id="probation_initial3" class="form-control required" size='4' style='width:100px !important;' value="<?php if(isset($sign) && $sign!='') print $sign;$sign='';?>"/>
			</div>
		...
		<div class="row">   
			<section class="col col-8">
				<div class="form-group">
					...
					<input  type="text" name="probation_form_sign" id="probation_form_sign" class="form-control required" value="<?php if(isset($data['form']['data']->form_sign)) print $data['form']['data']->form_sign;?>"/>
				</div>
			</section>
